# security-on-API-usingAWS-Cognito
Este repositório foi realizado como parte do desafio de projeto do Bootcamp da DIO - Cloud AWS
...
- Protocol - REST -> Create new API -> API name [dio_awsbootcamp_api] -> Endpoint Type - Regional -> Create API
...
- Inserir código da função ```put_item_function.js``` -> Deploy
...
- Domain name -> Domain prefix [dioawsbootcamp] -> Save
...
- Auth URL [https://dioawsbootcamp.auth.sa-east-1.amazoncognito.com/login]
